...
| PARSER_NAME_SQL_STRING_INFO | starSpider.parser.SQLStringParser | https://github.com/BeardedManZhao/SQLStringInFo | SQLString         |         YES          | 智能提取出所有的SQL语句，并通过SQLStringINFO解析库对语句进行解析，然后返回结果     |                    |
